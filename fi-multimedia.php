...
if(!class_exists('FI_Multimedia_Plugin')) {
    class FI_Multimedia_Plugin {
        ...
        function page_template_styles_scripts(){
            wp_enqueue_script('fontawesome', '//cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/js/all.min.js');
            ...
            wp_enqueue_style('fontawesome', '//cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css');
