...
$multi_service_request = $multi_service_url . 'api/multimedia/search/?q=' . urlencode($query) . '&fq=' .urlencode($filter) . '&start=' . $start . '&lang=' . $lang_dir;
...
$feed_url = real_site_url($plugin_slug) . 'multimedia-feed?q=' . urlencode($query) . '&filter=' . urlencode($filter);
